            ...
            <div class="cart-inside">
                <ul class="list">
                    <li class="item-cart">
                        <div class="product-img-wrap">
                            <a href="#" title="Product"><img
                                    src="{{ 'public' }}/img/product/cart_product_1.jpg" alt="Product"
                    ...
                    <li class="item-cart">
                        <div class="product-img-wrap">
                            <a href="#" title="Product"><img
                                    src="{{ 'public' }}/img/product/cart_product_2.jpg" alt="Product"
                                    class="img-responsive"></a>
                        </div>
                        <div class="product-details">
                            <div class="inner-left">
                    ...
                    <div class="cart-form">
                        <div class="cart-note-form">
                            <label for="CartSpecialInstructions"
                                class="cart-note cart-note_text_label small--text-center">Special Offer:</label>
    ...
    <div class="search-form-wrapper header-search-form">
        <div class="container">
            ...
            <form method="get" action="/search" role="search" class="search-form  has-categories-select">
                <input name="q" class="search-input" type="text" value=""
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <form method="post" class="form-customer form-login">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control form-account"
                            ...
                            <div class="col-md-4">
                                <form method="post" class="form-customer form-reset">
                                    ...
                                    <div class="btn-button-group mg-top-30 mg-bottom-15">
                                        <button type="submit" class="zoa-btn btn-login hover-white">Reset
                                            Password</button>
                                    </div>
                                </form>
                            </div>
                                ...
                                <form method="post" class="form-customer form-register">
                                    ...
                                    <div class="flex justify-content-between mg-30">
                                        <div class="checkbox">
                                            <input data-val="true"
                                                data-val-required="The Remember me? field is required."
                                                id="RememberMe2" name="RememberMe" type="checkbox" value="true" />
                                            <input name="RememberMe" type="hidden" value="false" />
                ...
                <div class="container container-content">
                    <div class="row flex align-items-center justify-content-between">
                                ...
                                <div class="element">
                                    <a href="#" class="icon-pushmenu js-push-menu">
                                        <svg width="26" height="16" version="1.1" id="Layer_1"
                                            ...
                                            <g>
                                                <line class="st0" x1="1.5" y1="1.5" x2="64.5"
                                                    y2="1.5" />
                                                <line class="st0" x1="1.5" y1="20.5" x2="64.5"
                                                    y2="20.5" />
                                                <line class="st0" x1="1.5" y1="39.5" x2="64.5"
                                                    y2="39.5" />
                                            </g>
                                        </svg>
                                    </a>
                        ...
                        <div class="col-md-3 col-xs-4 col-sm-4 col2 justify-content-center">
                            <a href="#"><img src="{{ url('public') }}/img/logo2.png" alt=""
                        ...
                        <div class="col-md-9 col-xs-4 col-sm-4 col2 flex justify-content-end">
                            <ul class="nav navbar-nav js-menubar hidden-xs hidden-sm">
                                ...
                                <li class="level1 hassub dropdown">
                                    <a href="{{ url('collect') }}" title="Collection">Collection</a>
                                </li>
                                <span class="plus js-plus-icon"></span>
                                    ...
                                    <ul class="level1">
                                        <li class="level2 col-6">
                                            <ul class="menu-level-2">
                                                <li class="level3"><a href="04-About.html" title="About Us">About
                                                        Us</a></li>
                                                <li class="level3"><a href="05-Contact.html"
                                                        title="Contact">Contact</a></li>
                                                <li class="level3"><a href="08-My-Account.html" title="My Account">My
                                                        Account</a></li>
                                                <li class="level3"><a href="09-Check-out.html"
                                                        title="Check out">Check out</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                            ...
                            <div class="topbar-left">
                                <div class="element element-search hidden-xs hidden-sm">
                                    <a href="#" class="zoa-icon search-toggle">
                                        <svg width="20" height="20" version="1.1" id="Layer_2"
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            ...
                                            <g>
                                                <path
                                                    d="M0,39.4C0,50,4.1,59.9,11.6,67.3c7.4,7.5,17.3,11.6,27.8,11.6c9.5,0,18.5-3.4,25.7-9.5l19.8,19.7c1.2,1.2,3.1,1.2,4.2,0
        ...
        S22.2,69.3,15.9,63C9.5,56.8,6,48.4,6,39.4s3.5-17.3,9.8-23.6S30.5,6,39.4,6S56.8,9.5,63.1,15.8z" />
                                ...
                                <div class="element element-user hidden-xs hidden-sm">
                                    <a href="#" class="zoa-icon js-user">
                                        <svg width="19" height="20" version="1.1" id="Layer_3"
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            viewBox="0 0 100 102.8" style="enable-background:new 0 0 100 102.8;"
                                            xml:space="preserve">
                                            <g>
                                                <path
                                                    d="M75.7,52.4c-2.1,2.3-4.4,4.3-7,6C82.2,58.8,93,69.9,93,83.5v12.3H7V83.5c0-13.6,10.8-24.7,24.3-25.1c-2.6-1.7-5-3.7-7-6
        C10.3,55.9,0,68.5,0,83.5v15.8c0,1.9,1.6,3.5,3.5,3.5h93c1.9,0,3.5-1.6,3.5-3.5V83.5C100,68.5,89.7,55.9,75.7,52.4z" />
                                                <g>
                                                    <path
                                                        d="M50,58.9c-16.2,0-29.5-13.2-29.5-29.5S33.8,0,50,0s29.5,13.2,29.5,29.5S66.2,58.9,50,58.9z M50,7
            C37.6,7,27.5,17.1,27.5,29.5S37.6,51.9,50,51.9s22.5-10.1,22.5-22.5S62.4,7,50,7z" />
                                ...
                                <div class="element element-cart">
                                    <a href="#" class="zoa-icon icon-cart">
                                        <svg width="20" height="20" version="1.1" id="Layer_4"
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            ...
                                            <g>
                                                <polygon
                                                    points="7.1,55.4 3.4,27.8 3.4,24.1 7.3,24.1 7.3,27.6 10.5,51.6 44.9,51.6 48.1,27.6 48.1,24.1 52,24.1 52,27.9
        48.3,55.4   " />
                                            </g>
                                            <g>
                                                <path
                                                    d="M14,31.4c-0.1,0-0.3,0-0.5-0.1c-1-0.2-1.6-1.3-1.4-2.3L19,1.5C19.2,0.6,20,0,20.9,0c0.1,0,0.3,0,0.4,0
        c0.5,0.1,0.9,0.4,1.2,0.9c0.3,0.4,0.4,1,0.3,1.5l-6.9,27.5C15.6,30.8,14.8,31.4,14,31.4z" />
                                            </g>
                                            <g>
                                                <path
                                                    d="M41.5,31.4c-0.9,0-1.7-0.6-1.9-1.5L32.7,2.4c-0.1-0.5,0-1.1,0.3-1.5s0.7-0.7,1.2-0.8c0.1,0,0.3,0,0.4,0
                ...
                <div class="shop-element left">
                    <ul class="js-filter">
                        <li class="filter filter-static hidden-xs hidden-sm">
                            <form class="form_newsletter" action="{{ url('shop/filter') }}" method="post">
                                @csrf
                                <input placeholder="search item" name="nama" class="newsletter-input form-control"
                                    value="{{ $nama ?? '' }}">
                    ...
                    @foreach ($list_produk as $produk)
                        <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 product-item">
                            <div class="product-img">
                                <a href=""> <img src="{{ url('public', $produk->foto) }}" alt=""
                                        class="img-responsive"></a>
            ...
            <div class="row">
                ...
                <div class="col-md-7 col-sm-6 col-xs-12 flex-end">
                    <form class="form_newsletter" action="#" method="post">
                        <input type="email" value="" placeholder="Enter your emaill" name="EMAIL"
    ...
    <footer class="footer v1 bd-top">
        <div class="container">
            <div class="f-content">
                ...
                <div class="f-col">
                    <a href=""><img src="{{ url('public') }}/img/credit-card-icons.png" alt=""
                            class="img-responsive"></a>
                </div>
            </div>
        </div>
